...
static void loop_task(void* arg)
{
  ...
  _begin();  // Sketch setup() called from within this function.
  ...
  while (1)
  {
    _process(); // Process incoming data here.
    loop();     // Sketch loop called here.
    yield();    // Yield to run other tasks, if any.

    // Process any Serial events before looping.
